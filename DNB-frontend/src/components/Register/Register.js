      ...
      <Row>
        ...
        >
          <Form
            ...
            method='post'
            id='loginform'
            className='border border-primary rounded mt-5 p-5 bg-white'
          >
            <h1>Register</h1>
            <FormGroup>
              <div className='inputGroup inputGroup1'>
                ...
                />
                <div>
                  {!this.validateEmail(this.state.registerData.email) ? (
              ...
              <div className='inputGroup inputGroup2 pt-3'>
                ...
                <Input
                  type='password'
                  id='passwortrepeat'
                  className='passwortrepeat'
                  name='passwortrepeat'
                  required
                  value={this.state.registerData.passwortrepeat}
                  onChange={this.handleChange}
                  placeholder='Enter Password again'
                />
              </div>
              <div className='inputGroup inputGroup3 pt-3'>
                <Button color='primary' block id='login'>
                  Register
                </Button>
              </div>
              <br />
